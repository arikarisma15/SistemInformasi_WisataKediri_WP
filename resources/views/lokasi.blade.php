    ...
    <div class="container">
        <div class="row">
            <div class="card">
                ...
                <h1></h1>
                <h1></h1>
                <h1 class="card-title text-center mb-4">Nilai Kriteria Lokasi</h1>
                 <!-- <p>Add <code>.table-bordered</code> for borders on all sides of the table and cells.</p> -->
                  <a href="/insertlokasi" class="btn btn-success">Tambah + </a>
                  <a href="/reportlokasi" class="btn btn-success">Cetak</a>
                  ...
                  <table class="table table-bordered">
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td>
                                <a href="/editLokasi/{{ $item->ID_Lokasi }}" class="btn btn-primary btn-sm">Update</a>
                                <a href="/deletelokasi/{{ $item->ID_Lokasi }}" class="btn btn-danger btn-sm">Delete</a>
                            </td>
                          </tr>
                        @endforeach
