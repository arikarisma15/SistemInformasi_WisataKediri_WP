        ...
        <div class="container">
            <div class="row">
                <div class="card">
                    ...
                    <a href="{{ url('reset') }}" class="btn btn-warning">Reset Perhitungan</a>
                      ...
                      <table class="table table-bordered">
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td>{{ $isi->Nilai_KriteriaLokasi }}</td>
                                <td>{{ $isi->Nilai_KriteriaFasilitas }}</td>
                                <td>{{ $isi->Nilai_KriteriaKeamanan }}</td>
                                <td>{{ $isi->Nilai_KriteriaObjekAtraksi }}</td>
                            </tr>
                            @endforeach 
                        </tbody>
                    </table>
            ...
            <div class="container">
                <div class="row">
                    <div class="card">
                        ...
                        <h1></h1>
                        <h1></h1>
                        <h1 class="card-title text-center mb-4">DATA NORMALISASI</h1>
                         <!-- <p>Add <code>.table-bordered</code> for borders on all sides of the table and cells.</p> -->
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    ...
                                    <td>{{ $isi->Nama_Wisata }}</td>
                                    <td>{{ $isi->s_lokasi }}</td>
                                    <td>{{ $isi->s_fasilitas }}</td>
                                    <td>{{ $isi->s_keamanan }}</td>
                                    <td>{{ $isi->s_objek }}</td>
                                    <td>{{ $isi->vektor_s }}</td>

                                    @php
                                        $total = $total + $isi->vektor_s;
                                    @endphp
                                </tr>
                                @endforeach 
                                <tr>
                                    <td colspan="6">
                                        <b><div align="right">Total Vektor :</div></b>
                                    </td>
                                    <td>{{ $total }}</td>
                                </tr>
                            </tbody>
                ...
                <div class="card">
                    <div class="card-body">
                        ...
                        <table class="table table-hover">
                            ...
                            <tbody>
                                ...
                                @php    
                                    ...
                                    $perhitungan_metode = json_decode( $metode->first()->data_json );
                                @endphp 
                                @foreach ( $perhitungan_metode AS $isi )
                                <tr>
                                    <td>{{ $isi->ID_Wisata }}</td>
                        ...
                        @php 
                            ...
                            $kes = $perhitungan_metode[0];

                        @endphp 
                        <p>Rekomendasi pariwisata yang dapat dikunjungi ..... adalah {{ $kes->Nama_Wisata }} dengan nilai vektor sebesar {{ $kes->vektor_v }}</p>
                    </div>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                ...
                <div class="col-md-12">
                    <div class="text-center">
                        @php echo svg() @endphp
                        <h2>Kosong</h2>
                        <p>Anda belum melakukan perhitungan metode Weight Product</p>

                        <a href="{{ url('hitung') }}" class="btn btn-primary">Hitung Metode</a>
                    </div>
                </div>
            </div>
        @endif 
