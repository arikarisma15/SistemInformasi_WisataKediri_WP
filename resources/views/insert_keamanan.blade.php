...
<head>
    ...
    <title>Insert Kriteria Keamanan</title>
        ...
        <div class="row">
            <div class="card">
                <div class="card-body">
                    ...
                    <!-- Vertical Form -->
                    <form class="row g-3" action="{{ url('/savekeamanan') }}" method="POST">
                        @csrf
                        <div class="col-12">
                            <label for="inputAddress" class="form-label">ID Keamanan</label>
                            <input type="text" name="id_keamanan" class="form-control" id="inputAddress">
                        </div>
                        <div class="col-12">
                        ...
                        <div class="col-12">
                            ...
                            <input type="text" name="nilai_kriteriakeamanan" class="form-control" id="inputEmail4">
                        </div>
